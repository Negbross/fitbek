...
#[server(UpdateForm, "/api")]
pub async fn update_form(payload: UpdateFormPayload) -> Result<(), ServerFnError> {
    use crate::app::services::form_service::FormService;
    use crate::app::services::user_service::UserService;
    use crate::app::utils::auth::validate_jwt;
    use crate::config::config::Config;
    ...
    FormService::update_form(&db, user_model.id, payload)
        .await
        .map_err(|e| ServerFnError::new(e.to_string()))?;
...
#[server(DeleteForm, "/api")]
pub async fn delete_form(form_id: String) -> Result<(), ServerFnError> {
    use crate::app::services::form_service::FormService;
    use crate::app::services::user_service::UserService;
    use crate::app::utils::auth::validate_jwt;
    use crate::config::config::Config;
    ...
    FormService::delete_form(&db, user_model.id, form_id)
        .await
        .map_err(|e| ServerFnError::new(e.to_string()))?;
