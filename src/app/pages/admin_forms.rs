use crate::app::controllers::form_controller::{create_form, get_form_responses, get_forms};
                                                ...
                                                <div class="bg-navy-800 p-6 rounded-2xl shadow-lg border border-navy-700 hover:border-blue-500 transition-colors duration-300 flex flex-col justify-between">
                                                    <div>
                                                        ...
                                                        <div class="text-navy-300 text-sm mb-4">
                                                            "Responses: " <span class="text-blue-400 font-bold">{item.response_count}</span>
                                                        </div>
                                                        <div class="bg-navy-900 py-2 px-3 rounded-lg text-sm text-navy-200 border border-navy-700 flex items-center justify-between">
                                                            <span>"Share: " <a href=format!("/f/{}", item.url_slug) target="_blank" class="text-blue-400 hover:underline">{format!("/f/{}", item.url_slug)}</a></span>
                                                        </div>
                                                    </div>
                                                    <div class="mt-6 flex justify-end">
                                                        <a
                                                            href=format!("/admin/forms/{}/responses", item.id)
                                                            class="bg-navy-700 hover:bg-navy-600 text-white px-4 py-2 rounded-lg transition-colors border border-navy-600"
                                                        >
                                                            "View Responses"
                                                        </a>
                                                    </div>
                                                        ...
                                                        {item.answers.into_iter().map(|ans| {
                                                            view! {
                                                                <div class="bg-navy-900/50 p-4 rounded-xl">
                                                                    <div class="text-xs text-navy-400 uppercase tracking-widest mb-1">"Question " {ans.question_id}</div>
